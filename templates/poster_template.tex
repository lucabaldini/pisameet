...
\title{A Wonderful Placeholder Poster---screen 1, id 0}
\author{Luca Baldini}
...
\begin{poster}
  ...
  \headerbox{Text}{name=textbox,column=0,span=3, below=abstract, height=0.44}
  {
    ...
    And here are different font sizes:
    \begin{itemize}
  ...
  \headerbox{Graphics}{name=graphbox,column=0, span=3, below=textbox, height=0.44}
  {
  ...
  \headerbox{Miscellanea}{name=miscbox,column=3,span=3, below=picbox, height=0.35}
  {
    More text.
  }
